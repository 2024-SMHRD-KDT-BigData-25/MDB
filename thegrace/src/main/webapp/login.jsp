...
<body>
    ...
    String redirectURI = URLEncoder.encode("http://localhost:8081/thegrace/main.jsp", "UTF-8");
            ...
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" action="Login">
                ...
                <div class="mb-2 d-flex">
                  <a><button type="button" class="btn btn-kakao auth-form-btn mr-1">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSR-r5pXVP_fv8IfNw9sZAnuQrvA8sunPgseg&s" alt="KakaoTalk" style="width: 20px; margin-right: 5px;">
                    KakaoTalk
                  </button></a>
                  <a href="<%=apiURL%>">
